...
<div style="display: flex; flex-wrap: nowrap; align-items: flex-start;">
 <div style="flex: 1 1 250px; min-width: 250px; max-width: 640px; margin-left: 278pxpx;">
  ...
  <div style="flex: 1 1 250px; min-width: 250px;">
    <h2 style="width:500px; margin-right: 563.665px; margin-top: 20px;">Digital Art</h2>
      <p style="width:900px; margin-right: 563.665px;">This section is about Digital Art</p>
  </div>
</div>
